...
5. **Given** el mismo conjunto de temas evaluado dos veces, una incluyendo un tema donde **ninguna** referencia quedó emparejada (el separador no produjo nada utilizable para ese tema — todas sus referencias resultan sin pareja, por el motivo que sea) y otra omitiendo ese tema del conjunto, **When** se comparan ambas medianas, **Then** la mediana que incluye ese tema es igual o peor que la que lo omite, nunca mejor — confirmando que omitir un tema completamente fallido no puede inflar el resultado. Esta garantía es específicamente sobre un tema sin ninguna referencia emparejada; un tema que mezcla algunas referencias sin pareja con otras muy bien emparejadas no está cubierto por esta garantía (research.md #12).
...
- **SC-004**: Al comparar la agregación de un mismo conjunto de temas con y sin un tema donde **ninguna** referencia quedó emparejada, la mediana que incluye ese tema nunca resulta mejor que la que lo omite — confirmando que el sistema no infla el resultado por omisión de un tema completamente fallido. No es una garantía general sobre cualquier tema que tenga *alguna* referencia sin pareja (research.md #12: un tema que mezcla fallos con aciertos muy buenos puede, matemáticamente, mover la mediana en cualquier dirección).
