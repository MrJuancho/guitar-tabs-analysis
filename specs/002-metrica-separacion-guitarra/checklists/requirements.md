...
- 2026-09-05 (antes de T024): SC-004/AS US2.5 afirmaban, sin verificarlo, que incluir CUALQUIER tema con al menos una referencia sin pareja nunca podía mejorar la mediana agregada. Es falso en general — contraejemplo verificado con cinco números (research.md #12): un tema que mezcla una referencia sin pareja con otras muy bien emparejadas puede subir la mediana. La garantía real solo es demostrable (estadística de orden: insertar copias del mínimo global nunca sube una mediana) cuando **todas** las referencias del tema quedan sin pareja — el caso que originó la garantía en la descripción inicial de la feature ("el separador no produjo nada para ese tema"). Se acotó AS US2.5, SC-004, la postcondición 8 de `agregar_conjunto` en el contrato, y T024, a ese caso.
